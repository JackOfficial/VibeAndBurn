...
|| $imageFileType == "gif") {
 move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file); 
    ...
    if(!empty($photo) and !empty($regno)){
     $sql = "INSERT INTO students(photo, regno) VALUES('$target_file', '$regno')";

if ($conn->query($sql) === TRUE) {
  $_SESSION['success'] = "New student created successfully";
  ?>
...
<div class="row">
    <div class="col-md-6 col-sm-12">
     ...
     <div class="card-body">
         <form method="POST" action="/datastructure/register" enctype="multipart/form-data">
             @csrf
  <div class="form-group">
    <label for="regno">Regitration Number:</label>
    <input type="text" class="form-control" name="regno" placeholder="Enter your Reg Number" id="regno" required />
  </div>
   <div class="form-group">
