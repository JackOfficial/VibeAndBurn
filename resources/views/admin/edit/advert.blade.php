      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <strong>FAILED:</strong> {{ Session::get('advertFail') }} </div> 
            @endif
              <form method="POST" action="{{route('advert.update', $ad->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    <textarea id="summernote" name="advert" class="form-control @error('advert') is-invalid @enderror" style="height: 300px" required>{{ $ad->advert }}</textarea>
                    @error('advert')
                    <span class="invalid-feedback" role="alert">
