    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          ...
          <strong><i class="fas fa-check"></i></strong> {{ Session::get('addSocialmediaSuccess') }} </div>
          @elseif(Session::has('addsocialmediaFail'))
          <div class="alert alert-danger alert-dismissible mb-2" style="margin: 5px 5px 0px 5px;">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> 
          <strong>FAILED:</strong> {{ Session::get('addsocialmediaFail') }} </div> 
            @endif

           <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title"><i class="fa fa-plus"></i> Add Social Media</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('socialmedia.store') }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('socialmedia') is-invalid @enderror" id="socialmedia" name="socialmedia" placeholder="Enter a Social Media Platform" required>
                            @error('socialmedia')
