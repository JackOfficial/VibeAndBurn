    ...
    <section class="content">
      ...
      <div class="row">
          <div class="col-12">
            ...
            @if (Session::has('deleteCategorySuccess'))
            <div class="alert alert-success alert-dismissible mb-2" style="margin: 5px 5px 0px 5px;">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> 
          <strong><i class="fas fa-check"></i></strong> {{ Session::get('deleteCategorySuccess') }} </div>
          @elseif(Session::has('deleteCategoryFail'))
          <div class="alert alert-danger alert-dismissible mb-2" style="margin: 5px 5px 0px 5px;">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> 
          <strong>FAILED:</strong> {{ Session::get('deleteCategoryFail') }} </div> 
            @endif

            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{ $categoryCounter }} Categories</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
