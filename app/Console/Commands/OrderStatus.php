...
class OrderStatus extends Command
{
    ...
    protected $description = 'Batch update order statuses, tracking counts, and auto-cancel invalid IDs';
        ...
        try {
            ...
            foreach ($orders as $order) {
                ...
                if (isset($data->status)) {
                    ...
                    // Build update array with live tracking data
                    $updatePayload = [
                        'status' => $newStatus,
                    ...
                    $updated = $order->update($updatePayload);
                    
                    if($updated) {
                        $this->info("    -> ID $id: Updated to $newStatus | Start: {$updatePayload['start_count']} | Remains: {$updatePayload['remains']}");
                    } else {
